   ...
   () =>{setModalReino(true)} */}
      ...
      <div className='projetos'>
        ...
        <div className='position'>
          ...
          {projetos.map(({nome,tecnologia,texto,codigo,demo,image}) =>{
          ...
          <div style = {{height:'60px', border:'1px solid red', width:'30%', marginTop:'50px', marginBottom:'50px',marginLeft:'35%'}}>
